...
import { createPaymentOrder } from '@/ai/flows/create-payment-order-flow';
...
export default function Dashboard() {
  ...
  const handleDonateNow = async () => {
    ...
    try {
      const order = await createPaymentOrder({ amount: amount * 100 }); // Amount in paise
      ...
      const options = {
        ...
        name: "Monthly Aid",
        description: "Donation to support families",
            ...
            try {
                ...
                setPaymentSuccess(true);
                 toast({
                    ...
                    description: `Your donation of ₹${amount} has been recorded.`,
                });
            } catch (error: any) {
                 toast({
                    variant: "destructive",
                    title: "Donation Logging Failed",
                    description: error.message || "Your payment was successful, but we failed to log it. Please contact support.",
                });
            }
        },
        prefill: {
                      ...
                      <CardContent className="space-y-4">
                        {paymentSuccess ? (
                           <div className="flex flex-col items-center justify-center text-center p-8 space-y-4">
                                ...
                                <p className="text-muted-foreground">Thank you for your generous contribution. Your support makes a real difference.</p>
                                <Button onClick={() => setPaymentSuccess(false)}>Make Another Donation</Button>
                            </div>
                        ) : (
                          <>
