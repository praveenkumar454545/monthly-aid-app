...
export function SubmitBeneficiary({ beneficiaries, setBeneficiaries }: SubmitBeneficiaryProps) {
    ...
    const handleGenerateSummary = async () => {
        ...
        // AI summarization is a server-side operation.
        // For static export, we'll just use the first 150 characters as a summary.
        setTimeout(() => {
            setSummary(story.slice(0, 150) + '...');
            toast({
                title: 'Summary Generated (Simulated)',
                description: 'A summary has been created from the story.',
            });
